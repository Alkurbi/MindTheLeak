...
export function buildResilience(
  ...
  return {
    ...
    confidenceAr,
    assumptionAr:
      "افتراض النموذج: في الأزمة يستمر دفع الالتزامات الأساسية والالتزامات الثابتة والتموينات الأساسية، ويتوقف كل إنفاق اختياري فوراً، وما يعجز عنه دخلك يتوقف دفعه ويستمر الباقي.",
    shield: {
      months: shieldMonths,
